export default {
  ...
  home: {
    hero: {
      ...
      subtitle: 'Découvrez la richesse culturelle et la beauté de l\'Ukraine à travers nos livres, nos événements et notre communauté passionnée',
  ...
  events: {
    ...
    subtitle: 'Découvrez et participez aux événements culturels, éducatifs et solidaires de notre communauté',
  ...
  association: {
    ...
    mission: {
      title: 'Notre Mission',
      description: 'Promouvoir la culture ukrainienne en France et favoriser les échanges culturels entre nos deux pays.'
    },
    values: {
      title: 'Nos Valeurs',
  ...
  about: {
    ...
    history: {
      ...
      description: 'Fondée en 2020, notre association s\'engage à promouvoir la culture ukrainienne en France.'
    },
    objectives: {
      title: 'Nos Objectifs',
  ...
  footer: {
    ...
    description: 'Notre association se consacre à la promotion de la culture ukrainienne à travers la littérature, l\'art et les échanges culturels.',
