      ...
      <div v-if="viewMode === 'list'" class="space-y-6">
        ...
        <div class="text-center mb-8">
          <p class="text-gray-600">
            {{ filteredEvents.length }} {{ t('common.event')
            }}{{ filteredEvents.length > 1 ? 's' : '' }} {{ t('common.found')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div class="relative overflow-hidden rounded-t-xl">
              <div
                class="aspect-video bg-gradient-to-br from-ukraine-blue/20 to-ukraine-yellow/20 flex items-center justify-center"
              >
            ...
            <div class="p-6">
              <h3
                class="text-xl font-semibold text-gray-900 mb-2 group-hover:text-ukraine-blue transition-colors"
              >
                {{ event.title }}
              </h3>
      ...
      <div v-else class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-6">
          ...
          <div class="flex space-x-2">
            <button @click="previousMonth" class="p-2 hover:bg-gray-100 rounded-lg">←</button>
      ...
      <div class="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form @submit.prevent="addEvent" class="p-6 space-y-6">
          ...
          <div class="flex justify-end space-x-4 pt-4">
            ...
            <button type="submit" class="btn-primary px-6 py-3">Ajouter l'événement</button>
          </div>
        </form>
      </div>
    </div>
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-1">
              <div
                class="aspect-video bg-gradient-to-br from-ukraine-blue/20 to-ukraine-yellow/20 rounded-xl flex items-center justify-center"
              >
            ...
            <div class="md:col-span-2 space-y-6">
              <div>
                ...
                <div class="flex flex-wrap gap-2 mb-4">
                  <span
                    class="px-3 py-1 text-sm font-medium bg-ukraine-blue/20 text-ukraine-blue rounded-full"
                  >
                    {{ selectedEvent.category }}
                  </span>
                  <span
                    class="px-3 py-1 text-sm font-medium bg-ukraine-yellow/20 text-ukraine-darkYellow rounded-full"
                  >
              ...
              <div class="flex items-center justify-between pt-4">
                ...
                <div class="flex items-center space-x-4">
                  <span class="text-sm text-gray-500">
                    {{ selectedEvent.attendees }} participant{{
                      selectedEvent.attendees > 1 ? 's' : ''
                    }}
                  </span>
                </div>
              </div>
...
const events = ref([
  {
    ...
    description:
      'Une soirée exceptionnelle pour découvrir la culture ukrainienne à travers la musique, la danse et la gastronomie traditionnelle.',
    icon: '🎭',
    registered: false,
    attendees: 45,
  },
  {
    ...
    description:
      "Cours d'initiation à la langue ukrainienne pour débutants. Découvrez les bases de cette belle langue slave.",
    icon: '📚',
    registered: true,
    attendees: 12,
  },
  {
    ...
    description:
      'Collecte de dons en faveur des populations ukrainiennes touchées par le conflit. Vêtements, médicaments et denrées alimentaires.',
    icon: '🤝',
    registered: false,
    attendees: 78,
  },
  {
    ...
    description:
      "Projection de films ukrainiens contemporains suivie d'une discussion avec les réalisateurs.",
    icon: '🎬',
    registered: false,
    attendees: 120,
  },
  ...
  },
  {
    ...
    description:
      "Exposition d'œuvres d'artistes ukrainiens contemporains, peintures, sculptures et installations.",
    icon: '🎨',
    registered: false,
    attendees: 34,
  },
